...
export const handleGetDailyBonus: RequestHandler = asyncHandler(async (req, res) => {
...
export const handleClaimDailyBonus: RequestHandler = asyncHandler(async (req, res) => {
  const playerId = req.user?.playerId;
...
export const handleGetBonusStreak: RequestHandler = asyncHandler(async (req, res) => {
  const playerId = req.user?.playerId;
