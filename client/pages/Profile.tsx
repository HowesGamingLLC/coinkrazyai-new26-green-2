...
import { UserMessagesSection } from '@/components/profile/UserMessagesSection';
import { SalesHistorySection } from '@/components/profile/SalesHistorySection';
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-1 rounded-xl h-14 w-full justify-start overflow-x-auto overflow-y-hidden scrollbar-hide">
          <TabsTrigger value="overview" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Overview
          </TabsTrigger>
          <TabsTrigger value="payments" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Payments
          </TabsTrigger>
          <TabsTrigger value="referrals" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Referrals
          </TabsTrigger>
          <TabsTrigger value="messages" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Messages
          </TabsTrigger>
          <TabsTrigger value="history" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Transaction History
          </TabsTrigger>
          <TabsTrigger value="settings" className="rounded-lg font-black uppercase text-xs tracking-widest italic data-[state=active]:bg-primary data-[state=active]:text-white h-full px-6 transition-all duration-300">
            Settings
          </TabsTrigger>
        </TabsList>
